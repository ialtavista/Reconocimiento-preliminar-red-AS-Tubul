...
var format_Descarga_6 = new ol.format.GeoJSON();
var features_Descarga_6 = format_Descarga_6.readFeatures(json_Descarga_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Descarga_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Descarga_6.addFeatures(features_Descarga_6);
var lyr_Descarga_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Descarga_6, 
                style: style_Descarga_6,
                popuplayertitle: 'Descarga',
                interactive: false,
                title: '<img src="styles/legend/Descarga_6.png" /> Descarga'
            });
...
var group_ObservacionesdeTerreno = new ol.layer.Group({
                                layers: [lyr_Descarga_6,lyr_PuntodeInters_7,],
                                fold: 'open',
...
lyr_OpenStreetMap_0.setVisible(true);lyr_GoogleSatelite_1.setVisible(true);lyr_Planimetrareferencial_2.setVisible(true);lyr_Colector_3.setVisible(true);lyr_Cmara_4.setVisible(true);lyr_PEAS_5.setVisible(true);lyr_Descarga_6.setVisible(true);lyr_PuntodeInters_7.setVisible(true);
...
lyr_Descarga_6.set('fieldAliases', {'fid': 'fid', });
...
lyr_Descarga_6.set('fieldImages', {'fid': '', });
...
lyr_Descarga_6.set('fieldLabels', {'fid': 'no label', });
