...
map.getView().fit([-8176681.231386, -4471732.327622, -8174720.646997, -4470692.021852], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Reconocimiento preliminar situación actual red AS Tubul.</h2>';
        return titleElement;
    })(),
